package com.luzhou.quartz.controller;

import com.alibaba.fastjson.JSONObject;
import com.luzhou.quartz.entity.SysJob;
import com.luzhou.quartz.exception.BizException;
import com.luzhou.quartz.service.ISysJobService;
import com.luzhou.quartz.util.Constant;
import com.luzhou.quartz.util.JsonUtil;
import com.luzhou.quartz.util.LayuiData;
import com.luzhou.quartz.util.SchedulerUtil;
...
public class JobController {
	...
	public String changeState(@RequestParam(value = "id") String idStr)throws Exception{
		...
		return JsonUtil.returnFront("变更定时任务状态成功", Constant.SYSCODE.SUCCESS).toJSONString();
